  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn className="text-center space-y-6 mb-12 lg:mb-20">
            <h2 className="text-3xl lg:text-5xl font-bold text-gray-900">Leadership Team</h2>
              ...
              <div className="group rounded-3xl shadow-xl transition-all duration-500 overflow-hidden hover:scale-105">
                <div className="relative">
                  <img
                    src="/mayowa.png"
                    alt="Dr. Mayowa Adeyemo"
                    className="w-full h-64 lg:h-80 bg-black object-contain transition-transform duration-500"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
                  <div className="absolute bottom-4 lg:bottom-6 left-4 lg:left-6 right-4 lg:right-6 text-white">
                    <h3 className="text-xl lg:text-2xl font-bold mb-2">Dr. Mayowa Adeyemo</h3>
                    <p className="text-blue-200 font-semibold text-base lg:text-lg">Managing Director/CEO</p>
                  </div>
                </div>
                ...
                <div className="p-6 lg:p-8 space-y-6 bg-white">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3 text-xs lg:text-sm text-gray-700">
            ...
            <ScaleIn delay={200}>
              <div className="group bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden hover:scale-105">
                <div className="relative">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
                  <div className="absolute bottom-4 lg:bottom-6 left-4 lg:left-6 right-4 lg:right-6 text-white">
                    <h3 className="text-xl lg:text-2xl font-bold mb-2">Olusola Arowojolu</h3>
                    <p className="text-purple-200 font-semibold text-base lg:text-lg">Chairman</p>
                  </div>
                </div>
          ...
          <FadeIn delay={300}>
            <div className="text-center mb-8 lg:mb-12">
              <h3 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">Advisory Board & Executive Team</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                ...
                <div className="group bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden hover:scale-105">
                  <div className="relative">
                    <img
                      src="/fayemiwo.png"
                      alt="Fayemiwo Ojo Omobola"
                      className="w-full h-48 lg:h-56 object-contain bg-black transition-transform duration-300"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                    
                    <div className="absolute bottom-4 left-4 right-4 text-white">
                      <h4 className="font-bold text-base lg:text-lg">Fayemiwo Ojo Omobola</h4>
                      <p className="text-green-200 text-sm">Member, Advisory Board</p>
                    </div>
                  </div>
                ...
                <div className="group bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden hover:scale-105">
                  <div className="relative">
                    <img
                      src="/philadephia.jpeg"
                      alt="Philadelphia Samuel"
                      className="w-full h-48 lg:h-56 object-contain transition-transform duration-300"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                    
                    <div className="absolute bottom-4 left-4 right-4 text-white">
                      <h4 className="font-bold text-base lg:text-lg">Philadelphia Samuel</h4>
                      <p className="text-indigo-200 text-sm">Executive Director</p>
                    </div>
                  </div>
              ...
              <SlideInRight delay={300}>
                <div className="group bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden hover:scale-105">
                  <div className="relative">
                    <img
                      src="/tunrayo.jpeg"
                      alt="Motunrayo Fasakin"
                      className="w-full h-48 lg:h-56 object-cover transition-transform duration-300"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                    <div className="absolute bottom-4 left-4 right-4 text-white">
                      <h4 className="font-bold text-base lg:text-lg">Motunrayo Fasakin</h4>
                      <p className="text-pink-200 text-sm">Member, Advisory Board</p>
                    </div>
                  </div>
                  ...
                  <div className="p-4 lg:p-6 space-y-4">
                    <p className="text-gray-600 text-xs lg:text-sm leading-relaxed">
                      Registered Nurse and healthcare strategist with 18+ years experience. Senior Case Manager at United Healthcare, 
                      specializing in healthcare economics and financial optimization.
                    </p>
                    <div className="pt-2 border-t border-gray-100">
                      <p className="text-xs text-pink-600 font-medium">BSN, MSN (in progress) - Healthcare Finance Expert</p>
                    </div>
                  </div>
                </div>
              </SlideInRight>
              ...
              <SlideInLeft delay={400}>
                <div className="group bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden hover:scale-105">
                  <div className="relative">
                    <div className="w-full h-48 lg:h-56 bg-gradient-to-br from-blue-900 to-gray-800 flex items-center justify-center">
                      <div className="text-center text-white p-4">
                        <Scale className="w-12 h-12 mx-auto mb-3 text-blue-300" />
                        <h4 className="font-bold text-base lg:text-lg">Barrister Ogungbemi</h4>
                        <h4 className="font-bold text-base lg:text-lg">Nelson Muyiwa</h4>
                      </div>
                    </div>
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                    <div className="absolute bottom-4 left-4 right-4 text-white">
                      <p className="text-blue-200 text-sm">Legal Adviser</p>
                    </div>
                  </div>
                  
                  <div className="p-4 lg:p-6 space-y-4">
                    <p className="text-gray-600 text-xs lg:text-sm leading-relaxed">
                      Seasoned legal practitioner with 10+ years experience. Principal Partner at Nelson M. Ogungbemi & Co., 
                      specializing in corporate law, regulatory compliance, and financial litigation.
                    </p>
                    <div className="pt-2 border-t border-gray-100">
                      <p className="text-xs text-blue-600 font-medium">LL.B - Corporate Law & Financial Regulation Expert</p>
                    </div>
                  </div>
                </div>
              </SlideInLeft>
