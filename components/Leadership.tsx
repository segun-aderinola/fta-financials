                    ...
                    <div className={`relative mb-4 overflow-hidden bg-gray-200 aspect-[4/5] ${isClickable ? 'group-hover:shadow-xl' : ''} transition-all duration-300`}>
                      ...
                      {isClickable && (
                        <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg">
                          <div className="absolute bottom-4 right-4 w-10 h-10 bg-white/90 rounded-full flex items-center justify-center shadow-lg transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                            <svg 
